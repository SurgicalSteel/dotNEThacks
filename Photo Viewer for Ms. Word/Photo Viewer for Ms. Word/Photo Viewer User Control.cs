...
{
    public partial class Photo_Viewer_User_Control : UserControl
    {
        static photo[] fotoku;
        static int nofoto, jmlfoto;
        public Photo_Viewer_User_Control()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                pictureBox1.Image = fotoku[0].img;
                nofoto = 0;
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (nofoto == 0)
            {
                ...
                pictureBox1.Image = fotoku[jmlfoto - 1].img;
                nofoto = jmlfoto - 1;
            }
            else
            {
                ...
                pictureBox1.Image = fotoku[nofoto - 1].img;
                nofoto -= 1;
            }
        }
